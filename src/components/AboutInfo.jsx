    ...
    return (
        <div className="flex flex-col mx-auto space-y-12">
            <div className="relative">
                ...
                <p className="w-full py-8 mx-auto -mt-2 subdesc text-center sm:max-w-3xl">We are a leading study abroad consultancy in India and abroad. We are a comprehensive solution for students, specializing in overseas MBBS education consultancy. </p>
            </div>
