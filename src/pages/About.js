        ...
        <div className="flex flex-col px-8 mx-auto space-y-12 max-w-7xl xl:px-12">
          ...
          <div className="flex flex-col mb-10 animated fadeIn sm:flex-row">
            ...
            <div className="flex flex-col justify-center mt-5 mb-8 md:mt-0 sm:w-1/2 md:w-7/12 sm:pr-16">
              ...
              <p className="mt-5 text-base text-gray-700 sm:text-left lg:text-lg">Whether you are looking for ranked university admissions after 12th, or affordable study programs or scholarships or may be internships during bachelors program or after that or a good Masters/ PhD program with excellent job opportunities, look no further, Mbbs Study Overseas has covered you all. Mbbs Study Overseas is an organisation that focuses on helping students succeed in their academic and professional lives. It works diligently for your profitability. At Mbbs Study Overseas, our motto is to give students the advantage of economical study and career pathways, secure the best university admissions, and open doors to excellent job opportunities. In short, we are here only to bring you benefits!</p>
            </div>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="flex flex-col px-8 mx-auto space-y-12 max-w-7xl xl:px-12">
          <div className="relative">
            ...
            <p className="w-full py-8 mx-auto -mt-2 text-base text-center text-gray-600 font-medium sm:max-w-3xl">Some important points to understand the significance of associating with Mbbs Study Overseas and how you can benefit with it.</p>
          </div>
          <div className="mb-10 animated fadeIn">
            <div className="mt-5">
              ...
              <p className="mt-5 mb-10 pb-10 border-b-2 text-base text-gray-600 text sm:text-left lg:text-lg lg:text-justify">Mbbs Study Overseas believes in giving students an advantage when it comes to affordable study options. They understand the financial challenges students face and strive to provide cost-effective solutions. Mbbs Study Overseas aims to give students the advantage of affordable study options through low-cost study programs, scholarships, grants, and financial aid opportunities to deserving students, making higher education more accessible and affordable. They understand that education can be expensive, so they strive to provide budget-friendly solutions for students. Suppose a student comes from a family with limited financial resources. Mbbs Study Overseas can help him/ her explore cost-effective programs, scholarships, grants, and other financial aid options to make their education more affordable, allowing them to pursue their dreams without worrying too much about the cost and also not compromising on the university standards.
              </p>
              <h3 className="mt-8 text-xl font-semibold sm:text-left sm:text-2xl text-gray-800">Comprehensive Programs and Resources</h3>
              <p className="mt-5 mb-10 pb-10 border-b-2 text-base text-gray-600 text sm:text-left lg:text-lg lg:text-justify">Mbbs Study Overseas offers comprehensive programs and resources designed to give students a competitive advantage in the ever-evolving academic and professional landscape. Mbbs Study Overseas provides online courses, mentorship programs, and access to a vast library of educational materials, enabling students to stay updated with the latest knowledge and trends in their fields. They provide support in various aspects, such as test preparation, career counseling, skill development, and more. Whether you need help with SAT/IELTS/ GRE/ GMAT preparation, guidance in choosing the right career path, or assistance in developing interview skills, Mbbs Study Overseas has programs and resources tailored to your needs. These resources ensure that you have the tools necessary to succeed academically and professionally.
              </p>
              <h3 className="mt-8 text-xl font-semibold sm:text-left sm:text-2xl text-gray-800">Excellent Job Opportunities</h3>
              <p className="mt-5 mb-10 pb-10 border-b-2 text-base text-gray-600 text sm:text-left lg:text-lg lg:text-justify">Mbbs Study Overseas opens doors to excellent job opportunities for students. They have strong connections with industry leaders and provide students with the necessary skills and resources to succeed in the professional world. Mbbs Study Overseas organizes job fairs, internships, online interviews and career development workshops where students can connect with potential employers and explore various career paths. They understand the evolving professional landscape and provide students with the necessary skills and resources to stand out in the job market. Mbbs Study Overseas can offer you internships, workshops, and networking opportunities with industry professionals. These experiences can enhance your resume and help you secure a desirable job during and after the study program.
              </p>
              <h3 className="mt-8 text-xl font-semibold sm:text-left sm:text-2xl text-gray-800">Best University Admissions</h3>
              <p className="mt-5 mb-10 pb-10 border-b-2 text-base text-gray-600 text sm:text-left lg:text-lg lg:text-justify">Mbbs Study Overseas aims to secure the best university admissions for its students. They have the expertise and knowledge to guide students through the application process and increase your chances of getting accepted into top-tier universities. Mbbs Study Overseas provides personalized assistance in preparing college applications, writing impactful essays, and conducting mock interviews to help students stand out and gain admission to their dream universities. If you aspire to study medicine, Mbbs Study Overseas will assist you in preparing for entrance exams, writing compelling personal statements, and acquiring the necessary recommendation letters, helping build your profile etc. Their guidance can significantly improve your chances of getting accepted into prestigious medical schools.
              </p>
              <h3 className="mt-8 text-xl font-semibold sm:text-left sm:text-2xl text-gray-800">Guaranteed Outcomes</h3>
              <p className="mt-5 mb-10 pb-10 border-b-2 text-base text-gray-600 text sm:text-left lg:text-lg lg:text-justify">Mbbs Study Overseas is committed to ensuring guaranteed outcomes for students. This means that they work tirelessly to help students achieve their goals and have a successful and fulfilling career. Mbbs Study Overseas offers specialized training programs that equip students with the necessary skills and knowledge to secure high-paying jobs in their chosen fields. Let's say you want to pursue a career in engineering. By joining Mbbs Study Overseas, you will get all the necessary guidance and support to secure admission to a top engineering university and increase your chances of landing a good job in the field.
              </p>
              <h3 className="mt-8 text-xl font-semibold sm:text-left sm:text-2xl text-gray-800">Maximum Benefits</h3>
              <p className="mt-5 mb-10 pb-10 text-base text-gray-600 text sm:text-left lg:text-lg lg:text-justify">Mbbs Study Overseas is dedicated to providing students with the maximum benefits they need to excel. This means that students can expect valuable resources, support, and guidance that will enhance their educational journey. By joining Mbbs Study Overseas, students gain access to budget-friendly study programs, exclusive study materials, personalized counseling, and networking opportunities with industry professionals.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
          ...
          <div className="space-y-8 flex flex-col items-start justify-center sm:grid sm:grid-cols-3 sm:gap-5 lg:gap-12 sm:space-y-0 text-center">
            <div className='flex flex-col items-center'>
              ...
              <p className="text-gray-600 w-52 sm:w-fit">info@Mbbs Study Overseas.co.in</p>
            </div>
            <div className='flex flex-col items-center'>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-gray-200 lg:h-12 lg:w-12 shadow-xl">
              ...
              <p className="text-gray-600">+91 8700732669 / <br /> +91 72268 41550</p>
            </div>
            <div className='flex flex-col items-center'>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-gray-200 lg:h-12 lg:w-12 shadow-xl">
              ...
              <p className="text-gray-600 w-52 sm:w-fit">Plot No 2/401, Dewan Estate, Mode, opposite Dwarka, Bhagwati Garden, New Delhi, Delhi 110059</p>
            </div>
          </div>
        </div>
      </section>
